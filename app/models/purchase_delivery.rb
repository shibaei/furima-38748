class PurchaseDelivery
  ...
  with_options presence: true do
    ...
    validates :item_id
    validates :postcode,
              format: { with: /\A\d{3}-\d{4}\z/, message: 'should be in the format of three digits, a hyphen, and four digits.' }
    validates :locality
    validates :block
  ...
  def save
    ...
    Delivery.create(postcode: postcode, province_id: province, locality: locality, block: block, apartment: apartment,
